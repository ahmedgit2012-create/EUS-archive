...
const SCHEMA = [
  ...
  { id: 'prep', l: 'secPrep', fields: [
    { k: 'prep.asa', l: 'ppAsa', t: 'radio', o: 'asa', span: 4 },
    { k: 'prep.consent', l: 'ppConsent', t: 'radio', o: 'yesno' },
    { k: 'prep.fasting', l: 'ppFasting', t: 'radio', o: 'yesno' },
    { k: 'prep.timeout', l: 'ppTimeout', t: 'radio', o: 'yesno' },
    { k: 'prep.co2', l: 'sdCo2', t: 'radio', o: 'yesno' },
    { k: 'prep.anticoag', l: 'ppAnticoag', t: 'checks', o: 'anticoag', span: 4 },
    { k: 'prep.anticoagPlan', l: 'ppAnticoagPlan', t: 'radio', o: 'anticoagPlan', span: 4, show: r => any(r.prep?.anticoag, ['aspirin', 'p2y12', 'warfarin', 'doac', 'lmwh']) },
    { k: 'prep.inr', l: 'ppInr', t: 'number' },
    { k: 'prep.plt', l: 'ppPlt', t: 'number' },
    { k: 'prep.abx', l: 'ppAbx', t: 'radio', o: 'yesnona' },
    { k: 'prep.abxName', l: 'ppAbxName', t: 'text', show: r => r.prep?.abx === 'yes' },
    { k: 'prep.sedation', l: 'sdType', t: 'radio', o: 'sedation', span: 4 },
    { k: 'prep.agents', l: 'sdAgents', t: 'text', span: 3 },
    { k: 'prep.position', l: 'sdPosition', t: 'select', o: 'position' },
  ]},
